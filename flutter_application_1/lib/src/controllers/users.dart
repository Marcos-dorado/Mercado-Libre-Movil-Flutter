...
Future<List<Users>> consultarUsuarios() async {
  final response =
      await http.get(Uri.parse('https://api-nodejs-1-6n9x.onrender.com/api/user'));
...
Future<void> eliminarUsuario(String idUsuario) async {
  final response = await http.delete(
    Uri.parse('https://api-nodejs-1-6n9x.onrender.com/api/user/$idUsuario'),
...
Future<void> updateUser(String idUsuario, String nombre, String correo) async {
  final url = Uri.parse('https://api-nodejs-1-6n9x.onrender.com/api/user/$idUsuario');
